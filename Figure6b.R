...
### Data ###
percent.change<-read.csv("C:/Users/agneh/Desktop/URSA/Data/percent_change_NO3.csv")

### Plot ###
#Percent change plot (Figure 6b)
percent.change$tributary<-factor(percent.change$tributary, levels = c("OBJ","Coal","Wash","Slate"))
